...
import (
	...
	"github.com/Josepavese/nido/internal/tui/validators"
...
// VMNameField creates a pre-configured VM name field.
func VMNameField() FormField {
	return NewFormField("Name", "vm-name", validators.VMName)
}

// TemplateNameField creates a pre-configured template name field.
func TemplateNameField() FormField {
	return NewFormField("Template", "template-name", validators.TemplateName)
}
